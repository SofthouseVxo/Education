...
import img1 from '../../media/javascript-images/javascript-2/java.png';
import img2 from '../../media/javascript-images/javascript-2/js.png';
import img3 from '../../media/javascript-images/javascript-2/webconsole.png';
