...
import img1 from '../../media/javascript-images/javascript-14/eventSteps.png';
import img2 from '../../media/javascript-images/javascript-14/bubbling.png';
import img3 from '../../media/javascript-images/javascript-14/callstack-1.png';
import img4 from '../../media/javascript-images/javascript-14/callstack-2.png';
import img5 from '../../media/javascript-images/javascript-14/callstack-3.png';
import img6 from '../../media/javascript-images/javascript-14/callstack-2.png';
import img7 from '../../media/javascript-images/javascript-14/callstack-1.png';
import img8 from '../../media/javascript-images/javascript-14/callstack-4.png';
...
#### Event Handling
<img src={img1} alt="Event handling"/>
...
<img src={img2} alt="event bubbling"/>
...
#### The call stack
<img src={img3} alt="call stack"/>


---
#### The call stack
<img src={img4} alt="call stack"/>


---
#### The call stack
<img src={img5} alt="call stack"/>


---
#### The call stack
<img src={img6} alt="call stack"/>


---
#### The call stack
<img src={img7} alt="call stack"/>


---
#### The call stack
<img src={img8} alt="call stack"/>
