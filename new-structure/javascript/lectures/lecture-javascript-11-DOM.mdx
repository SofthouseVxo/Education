...
import img1 from '../../media/javascript-images/javascript-11/JSGlobalObjects.png';
import img2 from '../../media/javascript-images/javascript-11/bom.png';
import img3 from '../../media/javascript-images/javascript-11/window.png';
import img4 from '../../media/javascript-images/javascript-11/location.png';
import img5 from '../../media/javascript-images/javascript-11/document.png';
import img6 from '../../media/javascript-images/javascript-11/domtree.png';
import img7 from '../../media/javascript-images/javascript-11/element.png';
...
#### Global JavaScript Objects
<img src={img1} alt="Browser Object Model"/>
...
<img src={img2} alt="Browser Object Model"/>


---

#### window object example (BOM)
<img src={img3} alt="dom - window"/>
...
---
#### window.location (BOM)
<img src={img4} alt="dom - window - location"/>
...
#### DOM/Node tree
<img src={img6} alt="dom - object model"/>
...
<img src={img7} alt="dom - element node"/>
