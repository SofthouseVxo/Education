...
import img1 from '../../media/javascript-images/javascript-22/proto1.png';
import img2 from '../../media/javascript-images/javascript-22/proto2.png';
import img3 from '../../media/javascript-images/javascript-22/proto3.png';
import img4 from '../../media/javascript-images/javascript-22/proto4.png';
import img5 from '../../media/javascript-images/javascript-22/proto5.png';
import img6 from '../../media/javascript-images/javascript-22/proto6.png';
import img7 from '../../media/javascript-images/javascript-22/proto7.png';
...
#### Prototype chain
<img src={img1} alt="prototype chain"/>


---
#### Prototype chain
<img src={img2} alt="prototype chain"/>


---
#### Prototype chain
<img src={img3} alt="prototype chain"/>


---
#### Prototype chain
<img src={img4} alt="prototype chain"/>


---
#### Prototype chain
<img src={img5} alt="prototype chain"/>


---
#### Prototype chain
<img src={img6} alt="prototype chain"/>


---
#### Prototype chain
<img src={img7} alt="prototype chain"/>
