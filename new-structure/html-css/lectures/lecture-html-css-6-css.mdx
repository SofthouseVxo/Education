...
import img1 from '../../media/html-css-images/html-css-5/box.png';
import img2 from '../../media/html-css-images/html-css-5/withCSS.png';
import img3 from '../../media/html-css-images/html-css-5/withoutCSS.png';
import img4 from '../../media/html-css-images/html-css-5/invisBox.png';
import img5 from '../../media/html-css-images/html-css-5/inline.png';
...
#### CSS Example
<img src={img1} alt="div with styles"/>


---

#### Web page with CSS
<img src={img2} alt="web page with css"/>


---

#### Web page without CSS
<img src={img3} alt="web page without css"/>
...
<img src={img4} alt="invisible element boxes"/>
...
#### Block and Inline elements
<img src={img5} alt="inline & block elements"/>
