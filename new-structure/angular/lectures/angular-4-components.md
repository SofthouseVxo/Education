...
<img width="600" src="/new-structure/media/angular-images/angular-4/shadowdom.png" alt="shadow dom">
...
#### Components
<img style="margin-top: -20px;" src="/new-structure/media/angular-images/angular-4/components.png" alt="components">
...
#### Components
<img style="margin-top: -20px;" src="/new-structure/media/angular-images/angular-4/components2.png" alt="components">
...
```
<img width="600" src="/new-structure/media/angular-images/angular-4/generate.png" alt="generate in cli">


---

#### Component metadata
<img src="/new-structure/media/angular-images/angular-4/meta.png" alt="components">
...
<img src="/new-structure/media/angular-images/angular-4/component3.png" alt="component overview">
...
<img width="800" src="/new-structure/media/angular-images/angular-4/binding1.png" alt="angular binding">


---

#### Binding types and targets
<img width="800" src="/new-structure/media/angular-images/angular-4/binding2.png" alt="angular binding">
