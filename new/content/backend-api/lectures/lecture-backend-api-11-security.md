...
#### Authentication vs. Authorization</h4>

---


#### Authentication</h4>
					<p>Proof of whom you are:</p>
					<ul>
						<li>Provide credentials</li>
						<ul>
							<li>Password + username/email</li>
								<li>API key</li>
						</ul>
...
#### Authorization</h4>
					...
					<ul>
						<li>Drive a car and a moped class 2.</li>
...
#### Best Practices for Web APIs</h4>
