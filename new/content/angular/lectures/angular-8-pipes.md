...
#### Pipes</h4>
					<ul>
            <li>A Pipe takes input data as input and transforms it into desired output.</li>
            <li>Angular provides us with a set of built in pipes.</li>
            <li>It is also possible to create custom pipes.</li>
          </ul>
...
#### Built in pipes</h4>
          <ul>
            ...
            <li>Json</li>
            <li><a href="https://angular.io/api?type=pipe">Full list of Pipes</a></li>
          </ul>
