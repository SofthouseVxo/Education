...
import img0 from "../../../../media/javascript-images/javascript-6/whatiscallbaks.jpg";
import img1 from "../../../../media/javascript-images/javascript-6/callback-example.png";
...
<img style={{width: 700}} src={img0} alt="callbacks"/>

---

#### Example callbacks

<img style={{width: 1200}} src={img1} alt="example callbacks"/>
