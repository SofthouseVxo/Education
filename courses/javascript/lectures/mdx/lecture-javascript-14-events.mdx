...
import img0 from "../../../../media/javascript-images/javascript-14/eventSteps.png";
import img1 from "../../../../media/javascript-images/javascript-14/bubbling.png";
import img2 from "../../../../media/javascript-images/javascript-14/callstack-1.png";
import img3 from "../../../../media/javascript-images/javascript-14/callstack-2.png";
import img4 from "../../../../media/javascript-images/javascript-14/callstack-3.png";
import img5 from "../../../../media/javascript-images/javascript-14/callstack-2.png";
import img6 from "../../../../media/javascript-images/javascript-14/callstack-1.png";
import img7 from "../../../../media/javascript-images/javascript-14/callstack-4.png";
...
#### Event Handling
<img src={img0} alt="Event handling"/>
...
<img src={img1} alt="event bubbling"/>
...
#### The call stack
<img style="margin-top: 0px; width: 800px;" src={img2} alt="call stack"/>


---
#### The call stack
<img style="margin-top: 0px; width: 800px;" src={img3} alt="call stack"/>


---
#### The call stack
<img style="margin-top: 0px; width: 800px;" src={img4} alt="call stack"/>


---
#### The call stack
<img style="margin-top: 0px; width: 800px;" src={img5} alt="call stack"/>


---
#### The call stack
<img style="margin-top: 0px; width: 800px;" src={img6} alt="call stack"/>


---
#### The call stack
<img style="margin-top: 0px; width: 800px;" src={img7} alt="call stack"/>
