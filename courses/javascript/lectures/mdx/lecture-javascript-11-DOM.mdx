...
import img0 from "../../../../media/javascript-images/javascript-11/JSGlobalObjects.png";
import img1 from "../../../../media/javascript-images/javascript-11/bom.png";
import img2 from "../../../../media/javascript-images/javascript-11/window.png";
import img3 from "../../../../media/javascript-images/javascript-11/location.png";
import img4 from "../../../../media/javascript-images/javascript-11/document.png";
import img5 from "../../../../media/javascript-images/javascript-11/domtree.png";
import img6 from "../../../../media/javascript-images/javascript-11/element.png";
...
<img style={{width: 800}} src={img0} alt="Browser Object Model"/>
...
<img style={{width: 800}} src={img1} alt="Browser Object Model"/>


---

#### window object example (BOM)
<img style={{width: 800}} src={img2} alt="dom - window"/>
...
---
#### window.location (BOM)
<img src={img3} alt="dom - window - location"/>
...
<img style={{width: 700}} src={img4} alt="dom - document"/>
...
#### DOM/Node tree
<img src={img5} alt="dom - object model"/>
...
<img src={img6} alt="dom - element node"/>
