...
import img1 from '../../../media/javascript-images/javascript-12/bom.png';
import img2 from '../../../media/javascript-images/javascript-12/domtree.png';
...
#### DOM/Node tree
<img src={img2} alt="dom - object model"/>
