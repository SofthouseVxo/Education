...
import img1 from '../../../media/angular-images/angular-2/mvc.png';
import img2 from '../../../media/angular-images/angular-2/semantic.png';
...
#### Semantic versioning
<img src={img2} alt="semantic versioning"/>
