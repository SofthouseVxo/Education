...
import img0 from "../../../..new/new-structure/media/angular-images/angular-3/blocks.png";
import img1 from "../../../../media/angular-images/angular-3/components.png";
import img2 from "../../../../media/angular-images/angular-3/components2.png";
import img3 from "../../../../media/angular-images/angular-3/component3.png";
import img4 from "../../../../media/angular-images/angular-3/componentTree.png";
import img5 from "../../../../media/angular-images/angular-3/angularoverview.png";
import img6 from "../../../../media/angular-images/angular-3/proj.png";
import img7 from "../../../../media/angular-images/angular-3/angularstart.png";
...
<img src={img0} alt="Angular building blocks"/>
...
#### Components
<img src={img3} alt="components tree"/>
...
#### Overview
<img style={{width: 800}} src={img5} alt="angular overview"/>
...
#### Project structure
<img  src={img6} alt="project structure"/>
...
<img src={img7} alt="angular bootstrap"/>
