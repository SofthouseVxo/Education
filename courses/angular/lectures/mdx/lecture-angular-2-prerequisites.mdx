...
import img0 from "../../../../media/mvc.png";
import img1 from "../../../../media/angular-images/angular-2/semantic.png";
...
#### MVC
<img style={{width: 800}} src={img0} alt="mvc overview"/>
...
#### Semantic versioning
<img src={img1} alt="semantic versioning"/>
