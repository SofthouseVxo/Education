...
import img1 from '../../../media/backend-api-images/backend-api-8/one.png';
import img2 from '../../../media/backend-api-images/backend-api-8/two.png';
import img3 from '../../../media/backend-api-images/backend-api-8/three.png';
import img4 from '../../../media/backend-api-images/backend-api-8/four.png';
import img5 from '../../../media/backend-api-images/backend-api-8/five.png';
import img6 from '../../../media/backend-api-images/backend-api-8/six.png';
import img7 from '../../../media/backend-api-images/backend-api-8/six.png';
...
<img style={{maxWidth: '500px', position: 'absolute', right: '6em'}} src={img1} alt="history"/>
...
<img style={{maxWidth: '500px', position: 'absolute', right: '6em'}}src={img2} alt="history"/>
...
<img style={{maxWidth: '500px', position: 'absolute', right: '6em'}}src={img3} alt="history"/>
...
<img style={{maxWidth: '500px', position: 'absolute', right: '6em'}}src={img4} alt="history"/>
...
<img style={{maxWidth: '500px', position: 'absolute', right: '6em'}}src={img5} alt="history"/>
...
<img style={{maxWidth: '500px', position: 'absolute', right: '6em'}}src={img6} alt="history"/>
...
<img style={{maxWidth: '500px', position: 'absolute', right: '6em'}}src={img7} alt="history"/>
