...
import img1 from '../../../media/backend-api-images/backend-api-12/public.png';
import img2 from '../../../media/backend-api-images/backend-api-12/services.png';
