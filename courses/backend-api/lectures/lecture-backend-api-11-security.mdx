...
import img1 from '../../../media/backend-api-images/backend-api-11/front.png';
import img2 from '../../../media/backend-api-images/backend-api-11/back.png';
import img3 from '../../../media/backend-api-images/backend-api-11/oauth.png';
...
<img style={{maxWidth: '600px'}} src={img1} alt="drivers license"/>
...
<img style={{maxWidth: '600px'}} src={img2} alt="drivers license"/>
