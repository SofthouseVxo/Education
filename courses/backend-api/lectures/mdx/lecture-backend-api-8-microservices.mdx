...
import img0 from "../../../../media/backend-api-images/backend-api-8/one.png";
import img1 from "../../../../media/backend-api-images/backend-api-8/two.png";
import img2 from "../../../../media/backend-api-images/backend-api-8/three.png";
import img3 from "../../../../media/backend-api-images/backend-api-8/four.png";
import img4 from "../../../../media/backend-api-images/backend-api-8/five.png";
import img5 from "../../../../media/backend-api-images/backend-api-8/six.png";
...
<img style={{width: 400}} src={img0} alt="history"/>
...
<img style={{width: 400}} src={img1} alt="history"/>
...
<img style={{width: 400}} src={img2} alt="history"/>
...
<img style={{width: 400}} src={img3} alt="history"/>
...
<img style={{width: 400}} src={img4} alt="history"/>
...
<img style={{width: 400}} src={img5} alt="history"/>
...
<img style={{width: 400}} src={img6} alt="history"/>
