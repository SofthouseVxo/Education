...
<img style={{maxWidth: '400px'}} src={img1} alt="Raster image"/>
<img style={{maxWidth: '400px'}} src={img2} alt="Pixels image"/>


---

#### Vectorgrafik
<img style={{maxWidth: '400px'}} src={img3} alt="Vector image"/>
...
<img style={{maxWidth: '400px'}} src={img4} alt="Vector image"/>
<img style={{maxWidth: '400px'}} src={img5} alt="Vector image"/>
...
#### .SVG exempel
<img style={{maxWidth: '400px'}} src={img6} alt="SVG code"/>
<img style={{maxWidth: '400px'}} src={img7} alt="Vector image"/>
...
<img style={{maxWidth: '400px'}} src={img8} alt="ppi example"/>
...
<img style={{maxWidth: '400px'}} src={img9} alt="rgb example"/>

---

#### Färger - CMYK

<img style={{maxWidth: '400px'}} src={img10} alt="cmyk example"/>
