...
import img1 from "../../../../media/android-dev-images/android-dev-6/android-dev-checkbox.png";
...
- <img style={{width: 350}} src={img1} alt="Checkboxes"/>
- ```XML
  <Spinner
...
- <img style={{width: 350}} src={img2} alt="Adapter"/>
