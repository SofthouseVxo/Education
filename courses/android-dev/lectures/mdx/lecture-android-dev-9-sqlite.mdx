...
import img0 from "../../../../media/android-dev-images/android-dev-9/android-dev-sqlite.png";
import img1 from "../../../../media/android-dev-images/android-dev-9/android-dev-cloud.png";
import img2 from "../../../../media/android-dev-images/android-dev-9/android-dev-databasemodel.png";
import img3 from "../../../../media/android-dev-images/android-dev-9/android-dev-sqlite-browser.png";
...
- Multiple ways to store data, with each method having it’s advantages and disadvantages.
  <img style={{width: 600}} src={img0} alt="sqlite and android"/>
...
- Google Firebase, Microsoft Azure & MongoDB.
  <img style={{width: 600}} src={img1} alt="Cloud"/>
...
- What operations do i need to use.
  ...
  <img style={{width: 400}} src={img2} alt="database model"/>
...
<img style={{width: 600}} src={img3} alt="sqlite browser"/>
