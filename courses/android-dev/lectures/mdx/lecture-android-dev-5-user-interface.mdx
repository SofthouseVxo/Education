...
<img width="350" src={img0} alt="Android Views"/>
...
<img width="350" src={img1} alt="Android Views2"/>
...
<img width="600" src={img2} alt="function list"/>
...
<img width="600" src={img3} alt="ViewGroup"/>
