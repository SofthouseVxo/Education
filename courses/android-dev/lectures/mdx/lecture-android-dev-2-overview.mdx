...
<img style={{width: '400px'}} src={img0} alt="android versions"/>
...
<img width="600" src={img1} alt="project config"/>
...
<img width="800" src={img2} alt="api levels"/>
...
<img width="1000" src={img3} alt="Window panes"/>
