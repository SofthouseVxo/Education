...
import img0 from "../../../../media/android-dev-images/android-dev-2/android-versions.jpg";
import img1 from "../../../../media/android-dev-images/android-dev-2/android-project-config.png";
import img2 from "../../../../media/android-dev-images/android-dev-2/android-api-levels.png";
...
<img style={{width: 600}} src={img0} alt="android versions"/>
...
<img style={{width: 600}} src={img1} alt="project config"/>
...
<img style={{width: 800}} src={img2} alt="api levels"/>
...
<img style={{width: 1000}} src={img3} alt="Window panes"/>
