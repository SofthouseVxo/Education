...
import img0 from "../../../../media/android-dev-images/android-dev-8/android-dev-layout-tools.png";
import img1 from "../../../../media/android-dev-images/android-dev-8/android-dev-landport.png";
import img2 from "../../../../media/android-dev-images/android-dev-8/android-dev-layout-debug.png";
import img3 from "../../../../media/android-dev-images/android-dev-8/android-dev-values-folder.png";
...
- <img style={{width: 600}} src={img0} alt="Layout tools"/>
...
- <img style={{width: 400}} src={img1} alt="Android Orientation example"/>
...
- <img style={{width: 500}} src={img2} alt="Layout debug"/>
...
- <img style={{width: 500}} src={img3} alt="Values folder"/>
