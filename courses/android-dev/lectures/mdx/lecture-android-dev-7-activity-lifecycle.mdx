...
import img0 from "../../../../media/android-dev-images/android-dev-7/android-dev-activity.gif";
import img1 from "../../../../media/android-dev-images/android-dev-7/android-dev-intent.png";
import img2 from "../../../../media/android-dev-images/android-dev-7/android-dev-activity-lifecycle.png";
import img3 from "../../../../media/android-dev-images/android-dev-7/android-dev-lifecycle1.gif";
import img4 from "../../../../media/android-dev-images/android-dev-7/android-dev-activity-lifecycle.png";
import img5 from "../../../../media/android-dev-images/android-dev-7/android-dev-uistate.gif";
...
<img style={{width: 350}} src={img0} alt="Activity gif"/>
...
- ```Java
    ...
    ```
- <img style={{width: 550}} src={img1} alt="Intent"/>

---

### Activity lifecycle

<img style={{width: 550}} src={img2} alt="Activity lifecycle"/>
...
- <img style={{width: 150}} src={img3} alt="lifecycle 1"/>
...
<img style={{width: 550}} src={img4} alt="Activity lifecycle"/>
...
- <img style={{width: 550}} src={img5} alt="UI State"/>
