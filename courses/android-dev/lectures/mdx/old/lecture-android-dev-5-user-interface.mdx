...
<img style={{ maxWidth: "350px" }} src={img1} alt="Android Views" />
...
<img style={{ maxWidth: "500px" }} src={img2} alt="Android Views2" />
...
<img style={{ maxWidth: "600px" }} src={img3} alt="function list" />
...
<img style={{ maxWidth: "600px" }} src={img4} alt="ViewGroup" />
