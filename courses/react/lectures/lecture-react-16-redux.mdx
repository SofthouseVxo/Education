...
import img1 from '../../../media/react-images/react-16/flux1.png';
import img2 from '../../../media/react-images/react-16/flux2.png';
import img3 from '../../../media/react-images/react-16/flux3.png';
import img4 from '../../../media/react-images/react-16/redux.png';
import img5 from '../../../media/react-images/react-16/redux1.png';
import img6 from '../../../media/react-images/react-16/redux2.png';
import img7 from '../../../media/react-images/react-16/redux3.png';
import img8 from '../../../media/react-images/react-16/React+Redux.png';
import img9 from '../../../media/react-images/react-16/StateMachine.png';
import img10 from '../../../media/react-images/react-16/reduxdev.png';
...
<img style={{maxWidth: '1000px', marginTop: '50px'}} src={img5} alt="redux"/>
...
<img style={{maxWidth: '1000px', marginTop: '50px'}} src={img6} alt="redux"/>
...
<img style={{maxWidth: '1000px', marginTop: '50px'}} src={img7} alt="redux"/>

---

#### Redux + React
<img style={{maxWidth: '1000px', marginTop: '50px'}} src={img8} alt="redux"/>


---

#### State machine
<img style={{maxWidth: '1000px', marginTop: '50px'}} src={img9} alt="state machine"/>
...
<img style={{maxWidth: '1000px', marginTop: '50px'}} src={img10} alt="state machine"/>
