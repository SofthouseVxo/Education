...
import img1 from '../media/html-css-images/html-css-12/google.png';
import img2 from '../media/html-css-images/html-css-12/sitemap.png';
import img3 from '../media/html-css-images-images/html-css-12/url.png';
...
<img src={img1} alt="google search example"/>
...
<img src={img2} alt="sitemap example"/>
...
<img src={img3} alt="url structure example"/>
