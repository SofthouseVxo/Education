...
import img1 from '../../../media/html-css-images/html-css-13/resp.png';
import img2 from '../../../media/html-css-images/html-css-13/grid.png';
...
<img src={img1} alt="different screens"/>
